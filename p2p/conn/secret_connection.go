...
import (
	...
	"github.com/ice-blockchain/cometbft/internal/async"
...
// https://github.com/ice-blockchain/cometbft/blob/main/spec/p2p/legacy-docs/peer.md#authenticated-encryption-handshake.
//
